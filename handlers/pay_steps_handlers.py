...
async def pay_to_card_send_data_handler(client, update: CallbackQuery):
    ...
    """
    await update.edit_message_text(
        text=f'💸<b>Переведите сумму, необходимую для пополнения баланса на карту:</b>\n'
             f'🔹Номер карты: <code>5559572078533793</code>\n'
             f'🔹Банк получателя: Альфа Банк\n\n'
             f'❕После перевода пришлите чек\n'
             f'🧾На чеке должна быть видна информация: <b>отправитель, получатель, сумма.</b>\n\n'
