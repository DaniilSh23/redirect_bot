...
async def faq_handler(client, update: CallbackQuery):
    ...
    await update.edit_message_text(
        text=f'‼️ Обязательно к прочтению.\n\n'
             ...
             f'самый день и в определенном после (например, текст + ссылка + картинка), '
             ...
             f'Вы можете потратить их на будущем редирект ссылки\n\n'
             ...
             f'сслыки - мы заменим Вам её или вернем сумму на баланс',
