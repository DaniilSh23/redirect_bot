...
async def faq_handler(client, update: CallbackQuery):
    ...
    await update.edit_message_text(
        text=f'‼️ Обязательно к прочтению.\n\n'
             ...
             f'8️⃣ Если Вы передумали делать редирект, но сумма на Вашем кабинете имеется - возврат средств не '
             f'предусмотрен в финансовом эквиваленте, Вы можете потратить их в будущем на редирект ссылки\n\n'
